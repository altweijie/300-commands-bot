...
const embed = new Discord.MessageEmbed()
  ...
  .setColor('RANDOM')
  .addField("Invite to Discord server", "[Invite the bot here (Recomended!)](https://discord.gg/yx4643FgAM)\n[Invite the bot here (Admin Perm)](https://discord.com/oauth2/authorize?client_id=928106731760943106&permissions=26038889663&scope=bot%20applications.commands)")
  .addField("Server", `[Join support server](https://discord.gg/yx4643FgAM)`)
