module.exports = {
    "registercommands" : false,
     "token": "OTI4MTA2NzMxNzYwOTQzMTA2.YdT8wA.ovqAg5B-4TrXf16ScfjBRX3IQJM",
...
defaultleavemessage: "{user} Left, Invited by {inviter}",
  basiclang: "en", //The basic language of the bot, "fr" for French and "en" for English
    ...
    auth: {
        support: "https://discord.gg/EVrnNxYdEN", //The link of your Discord server
